<?php /* Smarty version Smarty-3.1.14, created on 2026-06-28 22:48:09
         compiled from "C:\OSPanel\home\webasyst.local\wa-apps\shop\themes\default\header.html" */ ?>
<?php /*%%SmartyHeaderCode:20185701446a417a79e1e484-29384547%%*/if(!defined('SMARTY_DIR')) exit('no direct access allowed');
$_valid = $_smarty_tpl->decodeProperties(array (
  'file_dependency' => 
  array (
    'a2140b9e852a997c7f88244a349964b7b381678e' => 
    array (
      0 => 'C:\\OSPanel\\home\\webasyst.local\\wa-apps\\shop\\themes\\default\\header.html',
      1 => 1779089487,
      2 => 'file',
    ),
  ),
  'nocache_hash' => '20185701446a417a79e1e484-29384547',
  'function' => 
  array (
  ),
  'variables' => 
  ...
  'unifunc' => 'content_6a417a79ec5007_34565669',
),false); /*/%%SmartyHeaderCode%%*/?>
<?php if ($_valid && !is_callable('content_6a417a79ec5007_34565669')) {function content_6a417a79ec5007_34565669($_smarty_tpl) {?><?php if (!is_callable('smarty_function_wa_print_tree')) include 'C:\\OSPanel\\home\\webasyst.local\\wa-system/vendors/smarty-plugins\\function.wa_print_tree.php';
...
<?php }?>
    ...
    <?php if (isset($_smarty_tpl->tpl_vars['category']->value)){?>
        <?php $_smarty_tpl->tpl_vars['selected_category'] = new Smarty_variable($_smarty_tpl->tpl_vars['category']->value['id'], null, 0);?>
    <?php }else{ ?>
        <?php $_smarty_tpl->tpl_vars['selected_category'] = new Smarty_variable(null, null, 0);?>
    <?php }?>
...
?>
    ...
    <?php if (($_smarty_tpl->tpl_vars['theme_settings']->value['category_nav_mode']=='dropdown'||$_smarty_tpl->tpl_vars['wa']->value->isMobile())&&count($_smarty_tpl->tpl_vars['categories']->value)){?>
        <ul class="pages flyout-nav is-dropdown-nav">

            

            <li class="collapsible category-btn-item">
                <a href="javascript:void(0);" class="chevron down button nowrap">Каталог товаров</a>
                <div class="flyout">
                    <div class="container">
                        ...
                        <?php }else{ ?>
                            <p class="align-center gray">
                                <br><br>
                                Вы еще не создали ни одной категории товаров.
                            </p>
                        <?php }?>
                    </div>
                </div>
    ...
    <?php if ($_smarty_tpl->tpl_vars['theme_settings']->value['category_nav_mode']=='inline'&&!$_smarty_tpl->tpl_vars['wa']->value->isMobile()){?>
        <ul class="pages flyout-nav is-inline-nav">
...
" class="chevron down nowrap"><?php echo $_smarty_tpl->tpl_vars['cat']->value['name'];?>
</a>
                        <div class="flyout">
                            <div class="container">
...
"><?php echo $_smarty_tpl->tpl_vars['cat']->value['name'];?>
    ...
    <?php if ($_smarty_tpl->tpl_vars['theme_settings']->value['show_header_search']){?>
        <!-- product search -->
...
"><?php echo $_smarty_tpl->tpl_vars['cat']->value['name'];?>
    ...
    <?php if ($_smarty_tpl->tpl_vars['theme_settings']->value['category_nav_mode']=='dropdown'){?>
        <ul class="pages flyout-nav overflow-hidden is-pages">
            <?php if ($_smarty_tpl->tpl_vars['tagcloud']->value){?>
                
                <li class="collapsible">
                    <a href="javascript:void(0);" class="chevron down nowrap">Теги</a>
                    <div class="flyout">
                        <div class="container">
...
?>
                    <li class="collapsible">
                        <a href="javascript:void(0);" onClick="return false" class="chevron down nowrap">
